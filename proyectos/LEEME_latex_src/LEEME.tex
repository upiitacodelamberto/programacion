...
\begin{document}
\begin{flushright}
M\'exico D.F., Martes 22 de septiembre de 2015
\end{flushright}
...
podr\'as encontrar (entre otros) el programa {\tt HolaMundo.java} 
...
al directorio {\tt workspace} ``normalmente'' co\-rres\-pon\-de\-r\'an 
a proyectos gestionados a trav\'es del IDE Eclipse (que como 
...
Una ventaja de este programa es que ``no requiere instalaci\'on'' (ni en Windows ni en Linux). 
